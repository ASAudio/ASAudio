...
<table>
    ...
    <tbody>
        <tr>
            <td>The Sweet-Home speech and multimodal corpus for home automation interaction</td>
        ...
        <tr>
            <td>A French corpus for distant-microphone speech processing in real homes</td>
            <td><center>Multi</center></td>
            <td><center>Recorded</center></td>
        ...
        <tr>
            <td>Self-supervised generation of spatial audio for 360 video</td>
        ...
        <tr>
            <td>SECL-UMons database for sound event classification and localization</td>
            <td><center>Multi</center></td>
            <td><center>Recorded</center></td>
        ...
        <tr>
            <td>Learning representations from audio-visual spatial alignment</td>
            <td><center>FOA</center></td>
            <td><center>Crawled</center></td>
        ...
        <tr>
            <td>Easycom: An augmented reality dataset to support algorithms for easy communication in noisy environments</td>
            <td><center>Binaural</center></td>
            <td><center>Recorded</center></td>
            <td><center>5</center></td>
            <td><center>Speech</center></td>
        ...
        <tr>
            <td>Neural synthesis of binaural speech from mono audio</td>
            <td><center>Binaural</center></td>
            <td><center>Recorded</center></td>
        ...
        <tr>
            <td>Visually-guided audio spatialization in video with geometry-aware multi-task learning</td>
            <td><center>Binaural</center></td>
        ...
        <tr>
            <td>Spatial LibriSpeech: An augmented dataset for spatial audio learning</td>
            <td><center>FOA</center></td>
        ...
        <tr>
            <td>STARSS23: An audio-visual dataset of spatial recordings of real scenes with spatiotemporal annotations</td>
            <td><center>FOA</center></td>
            <td><center>Recorded</center></td>
        ...
        <tr>
            <td>ViSAGe: Video-to-Spatial Audio Generation</td>
            <td><center>FOA</center></td>
            <td><center>Crawled</center></td>
        ...
        <tr>
            <td>Both Ears Wide Open: Towards Language-Driven Spatial Audio Generation </td>
            <td><center>Binaural</center></td>
            <td><center>Simulated</center></td>
        ...
        <tr>
            <td>ISDrama: Immersive Spatial Drama Generation through Multimodal Prompting</td>
            <td><center>Binaural</center></td>
            <td><center>Recorded</center></td>
